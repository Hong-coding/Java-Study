...
abstract class Converter {
	...
	abstract protected double convert(double src);		// 추상메소드 형식 잘 만들어놓으면 단위 바꿔서 재사용가능
...
//		super.ratio = a;
//	}
	public Won2Dollar (int ratio){ //ㅡㅡㅡㅡ 더 간단하게
	}
	@Override
...
public class Test121 {
	public static void main(String[] args) {
		...
		toDollar.run();	//ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ부모 클래스의 메서드 사용 가능
